...
import os
from p3_ddpg_model import Actor, Critic
...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed):
        ...
        self.t_step = 0  #agent step
        self.l_step = 0  #update step
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if len(self.memory) > BATCH_SIZE and self.t_step % UPDATE_EVERY == 0:
            for i in range(UPDATE_COUNT):
                experiences = self.memory.sample() #sample batchsize
...
class OUNoise:
    ...
    def __init__(self, size, seed, mu=0.0, theta=0.15, sigma=0.5):
